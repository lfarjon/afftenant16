...
import { blockSubHeadingField } from 'src/app/core/forms/block-sub-heading';
...
@Component({
  selector: 'block-sub-heading',
  templateUrl: './sub-heading.component.html',
  styleUrls: ['./sub-heading.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SubHeadingComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  constructor(
    ...
    this.fields = [...blockSubHeadingField];
  }
